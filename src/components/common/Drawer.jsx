  ...
  return (
    <div className="fixed inset-0 z-50 overflow-hidden">
      ...
      <div className="absolute inset-y-0 right-0 max-w-full flex pl-4 sm:pl-10">
        {/* Sliding Panel */}
        <div className="w-screen max-w-md bg-slate-50 border-l border-slate-200 shadow-2xl flex flex-col justify-between animate-slide-in-right relative">
          
          {/* Header */}
          <div className="flex items-center justify-between p-5 border-b border-slate-200 bg-[#0f1624]/40 h-16">
