...
export default function Button({
  ...
  const variants = {
    ...
    danger: 'bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 text-neutral-50 shadow-lg shadow-red-500/25 hover:shadow-xl hover:shadow-red-500/40 focus:ring-red-500 border border-transparent',
    success: 'bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-600 hover:to-teal-700 text-neutral-50 shadow-lg shadow-emerald-500/20 hover:shadow-xl hover:shadow-emerald-500/35 focus:ring-emerald-500 border border-transparent',
    purple: 'bg-gradient-to-r from-purple-500 to-indigo-650 hover:from-purple-600 hover:to-indigo-750 text-neutral-50 shadow-lg shadow-purple-500/20 hover:shadow-xl hover:shadow-purple-500/35 focus:ring-purple-500 border border-transparent',
    info: 'bg-gradient-to-r from-sky-400 to-blue-600 hover:from-sky-500 hover:to-blue-700 text-neutral-50 shadow-lg shadow-blue-500/20 hover:shadow-xl hover:shadow-blue-500/35 focus:ring-blue-500 border border-transparent',
