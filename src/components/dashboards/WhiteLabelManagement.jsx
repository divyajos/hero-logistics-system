    ...
    <div className="space-y-6 text-left relative font-sans text-xs">
      ...
      {buildValidationWarnings.length > 0 && (
        <div className="p-3.5 bg-amber-500/10 border border-amber-500/20 rounded-2xl flex items-start gap-2.5 text-amber-400">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[11px] leading-relaxed text-slate-400">Fix these configuration parameters before running the static S3 CDN compiler deployment pipeline:</p>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4">
        <div className="glass rounded-2xl p-4 border border-[#23324C]/60 flex flex-col justify-between hover:scale-[1.02] transition-all">
          ...
          <strong className="text-xl sm:text-2xl font-black text-white mt-2">{activeWhiteLabelClients}</strong>
        ...
        <div className="glass rounded-2xl p-4 border border-[#23324C]/60 flex flex-col justify-between hover:scale-[1.02] transition-all">
          ...
          <strong className="text-xl sm:text-2xl font-black text-white mt-2">{activeDomainsCount}</strong>
        ...
        <div className="glass rounded-2xl p-4 border border-[#23324C]/60 flex flex-col justify-between hover:scale-[1.02] transition-all">
          ...
          <strong className="text-xl sm:text-2xl font-black text-white mt-2">Active</strong>
        ...
        <div className="glass rounded-2xl p-4 border border-[#23324C]/60 flex flex-col justify-between hover:scale-[1.02] transition-all">
          ...
          <strong className="text-sm font-black text-white mt-2 truncate">{config.lastDeployed}</strong>
        ...
        <div className="glass rounded-2xl p-4 border border-[#23324C]/60 flex flex-col justify-between hover:scale-[1.02] transition-all lg:col-span-2">
          <span className="text-[10px] font-bold text-slate-450 uppercase tracking-widest">Audit Events Today</span>
          <strong className="text-xl sm:text-2xl font-black text-white mt-2">{auditsTodayCount} Logs</strong>
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          {activeTab === 'dashboard' && (
            <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-6">
              ...
              <div className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/40 space-y-3">
                <span className="text-[10px] text-slate-400 font-bold uppercase tracking-wider block">Branding Build Releases History</span>
                <div className="space-y-3 font-mono text-[10px]">
                  {deployments.slice(0, 3).map((dep, idx) => (
                    <div key={idx} className="flex gap-3 items-start border-l border-[#23324C] pl-3.5 relative">
                      ...
                      <div className="flex-1 space-y-0.5">
                        ...
                        <p className="text-slate-400 text-[10px]">{dep.changeLog}</p>
                      </div>
                    </div>
                  ))}
                </div>
          ...
          {activeTab === 'branding' && (
            <form onSubmit={handleSaveConfig} className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-4">
              <div>
                <h3 className="text-base font-bold text-white">Branding Config Identity</h3>
                <p className="text-xs text-slate-400 mt-1">Configure company name details, light/dark brand logos, typography, fonts, loader files and borders.</p>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs text-slate-300">
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Loader Animation GIF (URL)</label>
                  <input
                    type="text"
                ...
                {/* Logo URLs inputs */}
                <div>
                  <label className="block text-slate-400 mb-1">Company Logo (Light Theme URL)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Company Logo (Dark Theme URL)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Favicon shortcut (URL)</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Login Screen Background URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Dashboard Background URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Email Branding Logo URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Invoice Branding Logo URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Manifest Branding Logo URL</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Typography Style</label>
                  <select
                ...
                <div>
                  <label className="block text-slate-400 mb-1">Button Radius Option</label>
                  <select
          ...
          {activeTab === 'theme' && (
            <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-6">
              <div>
                <h3 className="text-base font-bold text-white">System Theme Builder</h3>
                <p className="text-xs text-slate-400 mt-1">Design unlimited platform themes, clone designs, and compare version layout variables.</p>
              </div>

              {/* Themes list matrix */}
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                {themes.map((t, idx) => (
                  <div key={idx} className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/45 flex flex-col justify-between space-y-3">
                    <div>
                      <div className="flex justify-between items-center">
                        <strong className="text-white text-xs">{t.name}</strong>
                        <span className={`px-1.5 py-0.5 rounded text-[8px] font-bold ${
                          t.status === 'Published' ? 'bg-emerald-500/10 text-emerald-400 border border-emerald-500/20' : 'bg-slate-800 text-slate-500'
                        }`}>
                          {t.status}
                        </span>
                      </div>
                    ...
                    <div className="flex gap-1.5 justify-end">
                      <button
                        ...
                        className="px-2 py-1 bg-slate-900 border border-[#23324C] hover:text-white rounded text-[9px] font-bold"
                      >
                        Clone/Duplicate
                      </button>
                      {t.status !== 'Published' && (
              ...
              <form onSubmit={handleCreateTheme} className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/45 space-y-3">
                <span className="text-xs text-white font-extrabold block border-b border-[#23324C]/30 pb-2">Register Custom Theme Skin</span>
                <div className="flex gap-2">
                  <input
                    type="text"
                    value={newThemeName}
                    onChange={(e) => setNewThemeName(e.target.value)}
                    className="flex-1 bg-[#111827] border border-[#23324C] rounded-lg px-3 py-1.5 text-white outline-none"
          ...
          {activeTab === 'domain' && (
            <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-6">
              <div>
                <h3 className="text-base font-bold text-white">Domain & Routing Management</h3>
                  ...
                  <div key={idx} className="bg-[#0B0F19] p-3 rounded-xl border border-[#23324C]/45 flex justify-between items-center text-slate-350">
                    <div className="space-y-1">
                      <div className="flex items-center gap-2">
                        <strong className="text-white">{dom.domain}</strong>
                    ...
                    <button
                      ...
                      className="px-2.5 py-1 bg-slate-900 border border-[#23324C] hover:text-white rounded font-bold text-[10px]"
                    >
              ...
              <form onSubmit={handleAddDomain} className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/45 space-y-4">
                <span className="text-xs text-white font-extrabold block border-b border-[#23324C]/30 pb-2">Add Custom Domain Record</span>
          ...
          {activeTab === 'email' && (
            <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-6">
              <div>
                <h3 className="text-base font-bold text-white">Communications Engine Customizer</h3>
                <p className="text-xs text-slate-400 mt-1">Configure SMTP credentials and edit templates for invitations, dispatch notifications and welcome envelopes.</p>
              </div>

              {/* Template selection tab */}
              <div className="flex gap-1.5 border-b border-[#23324C]/40 pb-2 text-[11px] font-bold">
                {[
              ...
              <div className="space-y-4">
                <div className="grid grid-cols-1 gap-3">
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      rows={5}
                      className="w-full bg-[#0B0F19] border border-[#23324C] rounded-lg p-2.5 text-white outline-none"
                    />
                  </div>
                </div>

                {/* Email Test Dispatch Form */}
                <div className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/45 flex flex-col sm:flex-row gap-3 items-end text-xs">
                  <div className="flex-1">
                    <label className="block text-slate-400 mb-1">Enter Test Email Target Address</label>
                    <input
                      type="email"
                ...
                <div className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/45 flex flex-col sm:flex-row gap-3 items-end text-xs">
                  <div className="flex-1">
                    <label className="block text-slate-400 mb-1">Enter Test SMS Target Telephone</label>
                    <input
                      type="text"
          ...
          {activeTab === 'pdf' && (
            <form onSubmit={handleSaveConfig} className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-4">
              <div>
                <h3 className="text-base font-bold text-white">PDF Document customizer</h3>
            ...
            <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-4">
              <div className="flex justify-between items-center">
                ...
                <button
                  ...
                  className="px-2.5 py-1 bg-slate-900 border border-[#23324C] rounded text-brand-400 font-bold hover:text-brand-300"
                >
            ...
            <div className="space-y-6">
              ...
              <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-4">
                <div>
                  ...
                  <p className="text-xs text-slate-400 mt-1">Package styling parameters and configs to compile a static web app distribution bundle and push to S3 CDN.</p>
                </div>
                    ...
                    <div key={idx} className="bg-[#0B0F19] p-3 rounded-xl border border-[#23324C]/45 flex justify-between items-center text-slate-350">
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-2 py-1 bg-slate-900 border border-[#23324C] text-slate-300 hover:text-white rounded font-bold text-[10px]"
                        >
                          Diff Viewer
                        </button>
              ...
              <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-3 text-xs">
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="px-3.5 py-1 bg-slate-900 border border-[#23324C] text-white font-bold rounded-lg hover:text-brand-400 text-[10px]"
                  >
                    Export Audits CSV
                  </button>
                </div>
                ...
                <div className="flex gap-2 text-xs">
                  <input
                    ...
                    className="flex-1 bg-[#0B0F19] border border-[#23324C] rounded-lg p-2 text-slate-300 outline-none"
                    placeholder="Search action or details..."
                  />
                  <select
                    value={auditActionFilter}
                    onChange={(e) => setAuditActionFilter(e.target.value)}
                    className="bg-[#0B0F19] border border-[#23324C] rounded-lg p-2 text-slate-300 outline-none font-bold"
                  >
          ...
          {activeTab === 'security' && (
            <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-6">
              <div>
                <h3 className="text-base font-bold text-white">White Label Security</h3>
                <p className="text-xs text-slate-400 mt-1">Configure secure access restrictions, environmental variables secrets, allowed IP networks, and MFA enforcements.</p>
              </div>

              <div className="space-y-4 text-xs text-slate-300">
                <div className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/45 grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                  ...
                  <div>
                    <label className="block text-slate-400 mb-1">Branding Deployment Approval Policy</label>
                    <div className="flex items-center gap-2">
                      <input 
                        type="checkbox" 
                        ...
                        className="rounded bg-[#0B0F19] border-[#23324C] text-brand-500 h-4 w-4 cursor-pointer"
                      />
                      <span className="text-slate-300 font-semibold">Super Admin review required before CDN release</span>
                    </div>
                  </div>
                  <div>
                    <label className="block text-slate-400 mb-1">Session Timeout limits</label>
                    <select
                  ...
                  <div>
                    <label className="block text-slate-400 mb-1">Allowed IP networks (comma separated)</label>
                    <input
                      type="text"
                      value={ipWhitelist}
                ...
                <div className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/45 space-y-4">
                  <span className="text-xs text-white font-extrabold block border-b border-[#23324C]/35 pb-2">Developer Secrets & Webhook Credentials</span>
                  
                  <div className="space-y-2">
                    {apiKeys.map((keyInfo, idx) => (
                      <div key={idx} className="p-3 bg-[#111827] border border-[#23324C]/45 rounded-lg flex justify-between items-center text-slate-300">
                        <div className="space-y-1">
                          <strong className="block text-white text-[11px]">{keyInfo.name}</strong>
                  ...
                  <form onSubmit={handleCreateApiKey} className="flex gap-2 pt-2">
                    <input
                      ...
                      className="flex-1 bg-[#111827] border border-[#23324C] rounded-lg px-2.5 py-1.5 text-white outline-none"
                    />
                    <button
                      type="submit"
                      className="px-4 py-1.5 bg-brand-500 text-slate-950 font-black rounded-lg hover:bg-brand-400 transition-all flex items-center gap-1 cursor-pointer"
          ...
          {activeTab === 'integrations' && (
            <div className="glass rounded-2xl p-5 border border-[#23324C]/60 space-y-6">
              <div>
                <h3 className="text-base font-bold text-white">White Label API Integrations</h3>
                <p className="text-xs text-slate-400 mt-1">Manage connection details, Stripe billing integration, Twilio, SendGrid, and AWS CDN status configurations.</p>
              </div>
              ...
              <div className="space-y-4">
                {Object.keys(integrations).map(key => {
                  ...
                  return (
                    <div key={key} className="bg-[#0B0F19] p-4 rounded-xl border border-[#23324C]/45 flex justify-between items-center text-slate-350">
                      <div className="space-y-1 text-xs">
                        <strong className="capitalize text-white block text-sm">{key} Integration</strong>
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="px-3 py-1 bg-slate-900 border border-[#23324C] hover:text-brand-400 text-white rounded text-[10px] font-bold flex items-center gap-1 cursor-pointer"
                        >
                ...
                >
                  ...
                  <div className="space-y-2 text-left">
                    <div className="space-y-0.5">
                      ...
                      <div className="bg-slate-950 p-1.5 rounded border border-[#23324C]/40 text-slate-650 text-[9px]">admin@company.com</div>
                    </div>
                    <div className="space-y-0.5">
      ...
      {isDiffModalOpen && diffDetails && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80">
          <div className="bg-[#111827] border border-[#23324C] rounded-2xl w-full max-w-lg p-5 space-y-4 max-h-[85vh] overflow-y-auto">
            <div className="flex justify-between items-center border-b border-[#23324C]/60 pb-2">
              <strong className="text-white text-base">Branding Release Diff Viewer</strong>
              <button
            ...
            <div className="bg-[#0B0F19] rounded-xl border border-[#23324C]/45 overflow-hidden text-xs">
              <table className="min-w-full text-left border-collapse">
                <thead className="bg-[#161F30]/65 text-slate-500 font-bold text-[10px] uppercase">
                  <tr>
                ...
                <tbody className="divide-y divide-[#23324C]/30 text-slate-300 font-mono text-[11px]">
                  {diffDetails.map((diff, i) => (
                    <tr key={i} className="hover:bg-slate-900/20">
                      <td className="p-2.5 font-bold text-white font-sans">{diff.property}</td>
            ...
            <div className="flex justify-end pt-2">
              <button
                onClick={() => setIsDiffModalOpen(false)}
                className="px-4 py-2 bg-slate-900 border border-[#23324C] hover:text-white rounded-xl font-bold cursor-pointer text-xs"
              >
                Close Diff Viewer
              </button>
            </div>
